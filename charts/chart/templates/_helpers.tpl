...
*/}}
{{- define "solr-collections-operator.name" -}}
...
*/}}
{{- define "solr-collections-operator.fullname" -}}
...
*/}}
{{- define "solr-collections-operator.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "solr-collections-operator.resourceName" -}}
{{- $fullname := include "solr-collections-operator.fullname" .context }}
{{- $suffix := .suffix }}
