...
var _ = Describe("SolrCollectionSet Controller", func() {
	Context("When reconciling a resource", func() {
		...
		solrcollectionset := &solrcollectionsv1.SolrCollectionSet{}
		BeforeEach(func() {
			By("creating the custom resource for the Kind SolrCollectionSet")
			err := k8sClient.Get(ctx, typeNamespacedName, solrcollectionset)
		...
		AfterEach(func() {
			...
			By("Cleanup the specific resource instance SolrCollectionSet")
